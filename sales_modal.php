...
<p>You can pay now with credit card. <a href="pay.php"button type="button" class="btn btn-success" data-dismiss="modal"><span class="glyphicon glyphicon-success"></span>Pay for order now</button></a></p>
